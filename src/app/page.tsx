      ...
      <div className='xl:container mx-auto px-4 xl:px-0'>
        <div className="lg:flex mt-5 lg:items-center">
          <div className="lg:w-1/2">
            <h2 className='title mb-10'>{LANGUAGE[context.language].header.title}</h2>
            <p className='subtitle'>{LANGUAGE[context.language].header.subtitle}</p>
          ...
          <div className="lg:w-1/2 relative">
            ...
            <Image width={1000} height={1000} alt='header img' src={LANGUAGE[context.language].header.image}/>
          </div>
        </div>
      </div>
      <Feature/>
